...
const testimonials = [
  {
    name: "María González",
    role: "Madre de Carlos, 7 años",
    text: "La terapia ha hecho maravillas para mi hijo. Su confianza al hablar ha mejorado enormemente y ahora disfruta comunicándose con otros niños.",
    image: "/placeholder.svg?height=100&width=100",
  },
  {
    name: "Juan Pérez",
    role: "Padre de Ana, 5 años",
    text: "El enfoque personalizado realmente marcó la diferencia. Estamos muy agradecidos por el progreso de nuestra hija y el apoyo constante del equipo.",
    image: "/placeholder.svg?height=100&width=100",
  },
  {
    name: "Laura Martínez",
    role: "Madre de Sofía, 6 años",
    text: "Vimos mejoras significativas en solo unas pocas semanas. El ambiente acogedor y el personal dedicado hicieron que la terapia fuera una experiencia positiva para toda nuestra familia.",
    image: "/placeholder.svg?height=100&width=100",
  },
];
