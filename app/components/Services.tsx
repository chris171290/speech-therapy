...
// const services = [
//   {
//     title: "Evaluación del Habla y Lenguaje",
//     description:
//       "Evaluación completa de las habilidades de comunicación de su hijo para crear un plan de tratamiento personalizado.",
//     icon: "🕐",
//     details:
//       "Nuestras evaluaciones incluyen pruebas estandarizadas, observación clínica y entrevistas con los padres para obtener una comprensión completa de las habilidades y desafíos de comunicación del niño.",
//   },
//   {
//     title: "Terapia de Articulación",
//     description: "Ayudamos a los niños a pronunciar correctamente los sonidos y mejorar su claridad del habla.",
//     icon: "🗣️",
//     details:
//       "Utilizamos técnicas probadas y juegos divertidos para ayudar a los niños a dominar los sonidos difíciles y mejorar su confianza al hablar.",
//   },
//   {
//     title: "Terapia de Lenguaje",
//     description: "Trabajamos en la comprensión y expresión del lenguaje para mejorar la comunicación general.",
//     icon: "💬",
//     details:
//       "Nuestras sesiones de terapia de lenguaje se centran en expandir el vocabulario, mejorar la estructura de las oraciones y desarrollar habilidades de conversación apropiadas para la edad.",
//   },
// ]
...
//   return (
//     <section ref={ref} id="servicios" className="py-20 bg-main">
//       <div className="container mx-auto px-6">
//         <h2 className="text-4xl font-bold mb-12 text-center text-primary">Nuestros Servicios</h2>
...
//       >
//         <div className="absolute inset-0 bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition duration-300 backface-hidden">
...
//             className="mt-4 bg-primary text-black px-4 py-2 rounded hover:bg-primary-dark transition duration-300"
//           >
//             Más Detalles
//           </button>
//         </div>
