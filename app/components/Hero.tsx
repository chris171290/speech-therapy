...
export default function Hero() {
  ...
  return (
    <div className="mt-20 max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 py-3">
      <div className="relative grid lg:grid-cols-7 lg:gap-x-8 xl:gap-x-12 lg:items-center">
        <motion.div
        ...
        >
          <h1 className="block text-3xl font-bold text-gray-900 [text-shadow:_0_1px_0_rgb(0_0_0_/_50%)] sm:text-4xl lg:text-5xl lg:leading-tight">
          ...
          <p className="mt-3 text-xl text-gray-900 [text-shadow:_0_1px_0_rgb(0_0_0_/_40%)]">
            Play-based speech therapy that makes learning fun and engaging for
          ...
          <div className="mt-7 grid gap-3 w-full sm:inline-flex">
            <a
              className="py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-primary text-white hover:bg-secondary focus:outline-none focus:bg-secondary hover:text-black disabled:opacity-50 disabled:pointer-events-none"
              href="#"
            >
              Contact Us
              <svg
